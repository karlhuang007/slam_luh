...
def find_cylinder_pairs(cylinders, reference_cylinders, max_radius):
    ...
    for i in xrange(len(cylinders)):
        for j in xrange(len(reference_cylinders)):
            distance =sqrt( (cylinders[i][0]-reference_cylinders[j][0])*(cylinders[i][0]-reference_cylinders[j][0])+(cylinders[i][1]-reference_cylinders[j][1])*(cylinders[i][1]-reference_cylinders[j][1]))
